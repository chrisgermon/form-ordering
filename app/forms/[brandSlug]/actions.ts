...
\
{
  ...
  \
\
  const \{ brandId, brandSlug, ordered_by, ordered_by_email, location_id, notes \} =
    parsed.data;
\
  ...
  try \{\
    ...
    const submissionItems = Object.entries(items).map(\
...
\
    const pdfData: PdfData = \
      ...
      brandLogo: null, // Logo handling can be added here if needed\
