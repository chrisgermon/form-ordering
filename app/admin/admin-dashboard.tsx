              ...
              <div className="flex justify-between">
                ...
                <Badge
                  ...
                  className={cn({
                    ...
                    "bg-blue-100 text-blue-800": submission.status === "sent",
...
export default function AdminDashboard({
  ...
  }, [initialSubmissions, initialBrands, initialUploadedFiles])

  const filteredSubmissions = useMemo(() => {
    return submissions
      .filter((s) => (filterBrand === "all" ? true : s.brand_id === filterBrand))
      ...
      .filter((s) => {
        ...
        return (
          ...
          s.ordered_by?.toLowerCase().includes(query) ||
  ...
  }, [submissions, filterBrand, filterStatus, searchQuery, dateRange])
  ...
  const handleMarkAsCompleteClick = (submission: Submission) => {
    setSelectedSubmission(submission)
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div className="border-t border-gray-200 p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-center">
              <Input
                  ...
                  {filteredSubmissions.map((submission) => (
                    ...
                    >
                      ...
                      <TableCell onClick={(e) => e.stopPropagation()}>
                        {submission.status !== "completed" && (
                          <Button size="sm" onClick={() => handleMarkAsCompleteClick(submission)}>
                            Mark as Complete
                          </Button>
                        )}
                      </TableCell>
